...
def create_app():
    ...
    # Set up logging
    logging.basic?format='%(asctime)s - %(name)s - %(levelname)s - %(message)s'
    ...
    try:
        ...
        app.register_blueprint(annotations_bp)  # No URL prefix by default
        # If running under a subpath, uncomment the following:
        # app.register_blueprint(annotations_bp, url_prefix='/dashboard')
        logger.info("Blueprints registered successfully")
        logger.info("Annotations Blueprint registered with URL prefix: %s", annotations_bp.url_prefix or 'None')
    except Exception as e:
